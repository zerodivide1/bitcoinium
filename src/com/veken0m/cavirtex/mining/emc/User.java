package com.veken0m.cavirtex.mining.emc;
...
public class User {
	...
	public User(@JsonProperty("blocks_found") String blocks_found,
			@JsonProperty("confirmed_rewards") String confirmed_rewards,
			@JsonProperty("estimated_rewards") Number estimated_rewards,
			@JsonProperty("total_payout") String total_payout,
			@JsonProperty("unconfirmed_rewards") String unconfirmed_rewards) {
